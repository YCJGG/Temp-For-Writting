...
In this work,our primary goal is to overcome the limitations of the aforementioned methods and provide a practical solution to the scalable SBIR and sketch recognition problems.
